...
AI-Powered Email & URL Phishing Detection System
  ...
  Protect Your Digital Life with Intelligent Phishing Detection
  
    https://img.shields.io/badge/Python-3.8+-blue
    https://img.shields.io/badge/Flask-3.0+-green
    https://img.shields.io/badge/Machine%20Learning-Active-blueviolet
    https://img.shields.io/badge/License-MIT-brightgreen
  
  
    Features • Quick Start • Project Structure • Technical Details • Future Enhancements • Contributing
...
CapabilityIntegrated APIDescriptionMulti-engine URL scanningVirusTotalScan URLs/IPs/domains with 70+ antivirus enginesSmart browser-based scanning + ScreenshotsURLScan.ioBrowser scan, screenshot, behaviorKnown phishing DB checkPhishTankKnown phishing URLsGoogle threat database lookupSafe Browsing APIGoogle’s threat databaseIP reputation checkAbuseIPDBIP reputationDomain age & WHOIS analysisWHOISDomain age, registrar
...
APIPurposeVirusTotalScan URLs/IPs/domain with 70+ antivirus enginesURLScan.ioBrowser scan, screenshot, behaviorSafe BrowsingGoogle’s threat databaseAbuseIPDBIP reputationPhishTankKnown phishing URLsWHOISDomain age, registrar
Setup API Keys:

Visit 👉 http://localhost:5000/advanced_analysis
...
└── utils/                          # Utility modules
    ...
    └── api_handlers.py             # API handlers (renamed to avoid duplication)
🧠 Technical Details
✔️ Machine Learning
...
🚨 Example Detection
Email:
textFrom: security@paypa1-support.com
...
🤝 Contributing
Bashgit checkout -b feature/NewFeature
git commit -m "Added NewFeature"
git push origin feature/NewFeature
Open a Pull Request!
📄 License
MIT License — Free for personal & commercial use. See LICENSE for details.
❤️ Acknowledgments
